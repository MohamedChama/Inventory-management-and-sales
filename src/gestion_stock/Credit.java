...
public class Credit extends javax.swing.JFrame {
    ...
    public Credit() {
        try {
            ...
            ResultSet rs=st.executeQuery("select (nom_client ||' '|| prenom_client) as nom from clients order by nom_client");
            while(rs.next()){
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        try {
            ...
            ResultSet rs=st.executeQuery("select * from clients where (nom_client ||' '|| prenom_client)='"+jComboBox1.getSelectedItem()+"'");
